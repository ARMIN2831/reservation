    ...
    <div class="w-full max-w-[1240px] mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-12 128max:gap-4">
            ...
            <nav class=" flex items-center gap-[39px] 1024max:hidden 1280max:gap-6">
                ...
                <a href="{{ route('hotelBooking.results') }}" class=" text-sm text-neutral-700 font-normal transition-all duration-500 hover:text-green-300 hover:transition-none">
                    رزرو هتل
                </a>
                {{--<a href="#" class=" text-sm text-neutral-700 font-normal transition-all duration-500 hover:text-green-300 hover:transition-none">
                    تور های ترکیبی
                ...
                <a href="tel:09124714619"
                   class="text-sm text-neutral-700 font-normal transition-all duration-500 hover:text-green-300 hover:transition-none"
                   target="_blank"
        ...
        <div class=" flex items-center gap-3">
            ...
            <div class="flex items-center gap-3 640max:gap-2">
                    ...
                    <div id="user-profile-options-dropdown1" class="z-10 !mx-4 hidden min-w-[200px] rounded-[6px] overflow-hidden bg-light 512max:min-w-max">
                        <div class="w-full flex flex-col items-center rounded-[6px]">
                            ...
                            <ul class="w-full flex flex-col gap-5 p-5 640max:p-4 640max:gap-4">
                                <!-- item -->
                                <li class=" w-full">
                                    <a href="{{ route('userDashboard.index') }}" class=" flex items-center gap-[6px]">
                                        <!-- icon -->
                ...
                <a href="{{ route('hotelBooking.results') }}" class="rounded-full relative flex items-center justify-center aspect-square w-10 text-light bg-green-600 transition-all duration-500 ease-out hover:bg-green-300 hover:transition-none 640max:w-8">
