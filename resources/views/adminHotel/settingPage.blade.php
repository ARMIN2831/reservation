                ...
                <div class="w-full">
                    <div class="w-full flex flex-col gap-4.5">
                        ...
                        <div class="w-full flex flex-col gap-2">
                            <form method="post" action="{{ route("hotel.updateHotelSetting", $sharedData->id) }}" enctype="multipart/form-data" class="accordiion active w-full flex flex-col">
                                @csrf
                                <!-- button -->
                                ...
                                <div class="accordiion-content w-full flex flex-col gap-4.5 p-4.5 bg-light overflow-hidden">
                                    ...
                                    <div class="w-full grid grid-cols-3 gap-4.5 512max:grid-cols-1 768max:grid-cols-2">
                                        <div class="w-full flex flex-col gap-2">
                                            ...
                                            <input id="" name="title" value="{{ $sharedData->title }}" placeholder="نام هتل:" type="text" class=" w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                                        </div>
                                        <div class="w-full flex flex-col gap-2">
                                            <label for="" class=" text-base text-neutral-700 font-normal">
                                                شماره تماس
                                            </label>
                                            <input id="" name="mobile" value="{{ $sharedData->mobile }}" placeholder="شماره تماس" type="text" class=" w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                                        </div>
                                        <div class="w-full flex flex-col gap-2">
                                            <label for="" class=" text-base text-neutral-700 font-normal">
                                                امتیاز هتل
                                            </label>
                                            <input id="" name="star" value="{{ $sharedData->star }}" placeholder="امتیاز هتل" type="text" class=" w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                                        </div>
                                        <div class="w-full flex flex-col gap-2">
                                            <label for="" class=" text-base text-neutral-700 font-normal">
                                                ایمیل:
                                            </label>
                                            <input id="" name="email" value="{{ $sharedData->email }}" placeholder="ایمیل:" type="text" class=" w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                                        </div>
                                        <div class="w-full flex flex-col gap-2">
                                            <label for="" class=" text-base text-neutral-700 font-normal">
                                                وبسایت:
                                            </label>
                                            <input id="" name="website" value="{{ $sharedData->website }}" placeholder="وبسایت:" type="text" class=" w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                                        </div>
                                    </div>
                                    <!-- description -->
                                    <div class="w-full flex flex-col gap-2">
                                        ...
                                        <textarea id="" name="description" placeholder="توضیحات" type="text" class=" w-full min-h-[153px] rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">{{ $sharedData->description }}</textarea>
                                    </div>
                                    <!-- image upload -->
                                    <div class="w-full grid grid-cols-[200px_1fr] gap-4.5 640max:grid-cols-1">
                                        <!-- profile image -->
                                        <div class="w-full flex flex-col gap-2">
                                            <input name="logo" id="profile" class=" hidden" type="file">
                                            <label for="" class=" text-base text-neutral-700 font-normal">
                                                لوگو:
                                            </label>
                                            <div class="w-full aspect-square relative rounded-xl overflow-hidden group 512max:w-[180max] 640max:w-[200px]">
                                                <img id="profileImgElem" src="{{ asset('storage/' . $sharedData->logo) }}" class=" w-full h-full object-cover absolute z-[3] top-0 left-0">
                                        ...
                                        <div class="w-full flex flex-col gap-2">
                                            ...
                                            <div class="w-full h-[200px] relative rounded-xl overflow-hidden group 512max:h-[177px]">
                                                <img id="bannerImgElem" src="{{ asset('storage/' . $sharedData->banner) }}" class=" w-full h-full object-cover absolute z-[3] top-0 left-0">
                            ...
                            <form method="post" action="{{ route("hotel.updateHotelSettingPassword", $sharedData->id) }}" class="accordiion w-full flex flex-col">
                                @csrf
                                <!-- button -->
                                <div class="accordiion-button w-full flex items-center py-3 px-4.5 bg-light gap-2">
                                    <svg class=" w-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                        ...
                                        <div class="w-full grid grid-cols-3 gap-4.5 512max:grid-cols-1 640max:grid-cols-2">
                                            <div class="w-full flex flex-col gap-2">
                                                <div class="w-full flex flex-col gap-2">
                                                    ...
                                                    <input id="" name="LastPassword" placeholder="رمز فعلی" type="text" class=" w-full h-10 rounded-[6px] rounded-l-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none">
                                                </div>
                                            </div>
                                            <div class="w-full flex flex-col gap-2">
                                                <div class="w-full flex flex-col gap-2">
                                                    ...
                                                    <div class="inputContainer rounded-[6px] w-full flex items-center">
                                                        <input id="" name="password" placeholder="رمز جدید" type="password" class=" w-full h-10 rounded-[6px] rounded-l-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none">
                                            ...
                                            <div class="w-full flex flex-col gap-2">
                                                <div class="w-full flex flex-col gap-2">
                                                    ...
                                                    <div class="inputContainer rounded-[6px] w-full flex items-center">
                                                        <input id="" name="password_confirmation" placeholder="تکرار رمز جدید" type="password" class=" w-full h-10 rounded-[6px] rounded-l-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none">
                                                        <button class="showHideButton w-10 h-10 flex items-center justify-center rounded-[6px] rounded-r-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular p-2">
                                                            <svg class="eye-show w-4 text-neutral-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            ...
                            <div class="accordiion w-full flex flex-col">
                                ...
                                <div class="accordiion-content w-full flex flex-col gap-4.5 p-4.5 bg-light overflow-hidden">
                                    <div class="w-full p-4.5 pb-[51px] rounded-xl bg-neutral-50 flex flex-col gap-2">
                                        ...
                                        <!-- body -->
                                        <div class="w-full flex flex-col gap-2">
                                            @foreach($sharedData->users as $user)
                                            <!-- item -->
                                            <div class="w-full bg-light rounded-xl p-4.5 flex flex-col gap-4.5 items-center 768max:bg-green-100">
                                                <div class="w-full grid grid-cols-[0.7fr_0.6fr_0.7fr_0.7fr_0.8fr_150px] gap-2 768max:grid-cols-[70px_1fr_70px] 1024max:grid-cols-[90px_110px_95px_1fr_95px_56px] 1280max:grid-cols-[0.7fr_0.6fr_0.7fr_0.7fr_0.8fr_56px]">
                                                    ...
                                                    <div class="w-full flex items-center justify-end gap-2">
                                                        <a onclick="openEditPopUp(addOReditUsers, {{ json_encode($user) }})" class="editButton flex items-center justify-center gap-2">
                                                        ...
                                                        <a href="{{ route('hotel.deleteUser', $user->id) }}" class="flex items-center justify-center gap-2">
                                                            <div class=" w-6 aspect-square rounded-[6px] bg-green-300 flex items-center justify-center text-light">
                                        ...
                                        <!-- add button -->
                                        <div class="w-full">
                                            <a onclick="modalController(addOReditUsers)" class=" w-full flex items-center gap-3 py-[21px] px-4.5 bg-green-300 rounded-xl 768max:bg-[#8CB39880]">
                    ...
                    <div class="w-full flex-grow-[1] flex flex-col gap-8 max-h-[500px] overflow-y-auto">
                        ...
                        <div class="w-full grid grid-cols-2 gap-4.5 512max:grid-cols-1">
                            <div class="w-full flex flex-col gap-2">
                                ...
                                <input id="" name="username" placeholder="نام کاربری" type="text" class="username w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                            </div>
                            <div class="w-full flex flex-col gap-2">
                                <label for="" class=" text-sm text-neutral-700 font-normal">
                                    ایمیل :
                                </label>
                                <input id="" name="email" placeholder="ایمیل" type="text" class="email w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                            </div>
                            <div class="w-full flex flex-col gap-2">
                                <label for="" class=" text-sm text-neutral-700 font-normal">
                                    نام :
                                </label>
                                <input id="" name="firstName" placeholder="نام" type="text" class="firstName w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                            </div>
                            <div class="w-full flex flex-col gap-2">
                                <label for="" class=" text-sm text-neutral-700 font-normal">
                                    نام خانوادگی :
                                </label>
                                <input id="" name="lastName" placeholder="نام خانوادگی" type="text" class="lastName w-full rounded-[6px] bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none focus:border-[1px] focus:border-neutral-400">
                            </div>
                            <div class="w-full flex flex-col gap-2">
                                <label for="" class=" text-sm text-neutral-700 font-normal">
                                    نقش کاربر:
                                </label>
                                <select name="role" id="countries" class="role bg-neutral-50 text-black font-normal text-xs rounded-[6px] focus:outline-none focus:border-[1px] focus:border-neutral-400 block w-full p-2.5">
                                    <option value="مدیر اصلی" class="text-neutral-700 !font-farsi-regular font-normal text-xs transition-all duration-500 hover:bg-neutral-200 hover:transition-none aria-selected:bg-neutral-200">
                                        مدیر اصلی
                                    </option>
                                    <option value="ویرایشگر" class="text-neutral-700 !font-farsi-regular font-normal text-xs transition-all duration-500 hover:bg-neutral-200 hover:transition-none aria-selected:bg-neutral-200">
                                        ویرایشگر
                                    </option>
                                    <option value="ادمین" class="text-neutral-700 !font-farsi-regular font-normal text-xs transition-all duration-500 hover:bg-neutral-200 hover:transition-none aria-selected:bg-neutral-200">
                                        ادمین
                                    </option>
                                    <option value="مالک" class="text-neutral-700 !font-farsi-regular font-normal text-xs transition-all duration-500 hover:bg-neutral-200 hover:transition-none aria-selected:bg-neutral-200">
                                        مالک
                                    </option>
                                </select>
                            </div>
                            <div class="w-full flex flex-col gap-2">
                                ...
                                <div class="inputContainer rounded-[6px] w-full flex items-center">
                                    <input id="" name="password" placeholder="رمز عبور" type="password" class=" w-full h-10 rounded-[6px] rounded-l-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 focus:outline-none">
                                    <button class="showHideButton w-10 h-10 flex items-center justify-center rounded-[6px] rounded-r-none bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular p-2">
                                        <svg class="eye-show w-4 text-neutral-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
