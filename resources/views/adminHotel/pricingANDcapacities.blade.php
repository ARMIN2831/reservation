...
@section('content')
                    ...
                    <div class="w-full flex flex-col items-center gap-5 1024max:hidden">
                        ...
                        <div class="w-full flex flex-col gap-4.5">
                            ...
                            <div class="w-full flex flex-col items-center gap-2">
                                <!-- head -->
                                <div class="w-full grid grid-cols-[246px_540px_1fr] gap-4 items-center p-4.5 rounded-xl bg-green-300 1280max:grid-cols-[150px_540px_1fr]">
                                    ...
                                    <div class="w-full grid grid-cols-2 justify-items-center gap-16 1280max:gap-4">
                                        <div class="w-full flex items-center justify-center gap-2">
                                            <label for="dadash1" class=" text-xs text-light font-normal">
                                                اتاق سینگل اکونومی
                                            </label>
                                            <input id="dadash1" name="sallam" type="checkbox" class=" hidden">
                                            <label for="dadash1" class=" w-4.5 aspect-square bg-light rounded-[2px] flex items-center justify-center" style="box-shadow: 0px 0px 10px 0px #8CB3984D;">
                                        ...
                                        <div class="w-full flex items-center justify-center gap-2">
                                            <label for="dadash" class=" text-xs text-light font-normal">
                                                اتاق دبل اکونومی
                                            </label>
                                            <input id="dadash" name="sallam" type="checkbox" class=" hidden">
                                            <label for="dadash" class=" w-4.5 aspect-square bg-light rounded-[2px] flex items-center justify-center" style="box-shadow: 0px 0px 10px 0px #8CB3984D;">
                                                <svg class=" w-[12px] text-green-300" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0.75 4.75L4.25 8.25L11.25 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                            </label>
                                ...
                                <div class="w-full flex flex-col items-center">
                                    <!-- head -->
                                    <div class="w-full grid grid-cols-[246px_540px_1fr] gap-4 items-center py-2 px-4.5 rounded-xl bg-[#8CB39880] 1280max:grid-cols-[150px_540px_1fr]">
                                        <div class="w-full"></div>
                                        <div class="w-full grid grid-cols-2 justify-items-center items-center gap-16 1280max:gap-4">
                                    ...
                                    <div class="w-full flex flex-col gap-2">
                                        <!-- item -->
                                        <div class="w-full p-4.5 rounded-xl even:bg-[#DBF0DD80] odd:bg-light grid grid-cols-[246px_540px_1fr] gap-4 items-center relative 1280max:grid-cols-[150px_540px_1fr]">
                                            <!-- checkbox -->
                                            <div class=" absolute z-[2] right-4.5 top-0 bottom-0 my-auto flex items-center justify-center 1280max:bottom-auto 1280max:top-4.5">
                                                <input id="examplaeId1" name="exampleName" type="checkbox" class=" hidden">
                                                <label for="examplaeId1" class=" w-4.5 aspect-square bg-light rounded-[2px] flex items-center justify-center" style="box-shadow: 0px 0px 10px 0px #8CB3984D;">
                                                    <svg class=" w-[12px] text-green-300" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M0.75 4.75L4.25 8.25L11.25 0.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </svg>
                                                </label>
            ...
            <div class=" modal-content w-full h-full flex items-center justify-center">
                <form action="#" class="w-full max-w-[800px] p-4.5 bg-light rounded-xl flex flex-col">
                                ...
                                <div class="w-full flex items-center content-start gap-x-2 gap-y-3 flex-wrap">
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff1" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff1" name="">
                                            <span>
                                                شنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff2" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff2" name="">
                                            <span>
                                                یکشنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff3" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff3" name="">
                                            <span>
                                                دوشنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff4" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff4" name="">
                                            <span>
                                                سه شنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff5" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff5" name="">
                                            <span>
                                                چهارشنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff6" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff6" name="">
                                            <span>
                                                پنج شنبه
                                            </span>
                                        </label>
                                    ...
                                    <div class="flex-shrink-[0]">
                                        <label for="fffff7" class="checkbox-item-button h-[40px] transition-all duration-200 ease-out px-6 px-[26px] rounded-[20px] bg-neutral-50 flex items-center justify-center text-xs text-neutral-200 font-normal font-farsi-regular">
                                            <input class="hidden" type="checkbox" id="fffff7" name="">
                                            <span>
                                                جمعه
                                            </span>
                                        </label>
                    ...
                    <div class="w-full flex items-center justify-end gap-4.5 pt-4.5">
                        <button onclick="modalController(document.querySelector('.rateDeterminationModal'))" class=" rounded-[6px] flex items-center justify-center py-2 px-4 min-w-[140px] text-[14px] text-light font-medium font-farsi-medium bg-green-300 transition-all duration-400 ease-out hover:bg-green-100 hover:text-green-600 512max:min-w-[0px] 512max:flex-grow-[1] 512max:px-2">
                            بازگشت
                        </button>
        ...
        <div class="hotelEditInfoModal modal w-[100vw] h-[100vh] fixed z-[15] top-0 left-0 bg-[#0000002c] px-6 py-4">
            <div class=" modal-content w-full h-full flex items-center justify-center">
                <form action="#" class="w-full max-w-[800px] p-4.5 bg-light rounded-xl flex flex-col">
                    <div class="w-full flex flex-col gap-8 max-h-[500px] overflow-y-auto">
                        <!-- header -->
                        ...
                        <div class="w-full flex flex-col gap-4.5 px-4.5 py-1 640max:px-0">
                            <div class="w-full flex flex-col gap-1">
                                ...
                                <input type="text" class=" w-full rounded-xl bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400
                            ...
                            <div class="w-full flex flex-col gap-1">
                                ...
                                <textarea class=" min-h-[200px] w-full rounded-xl bg-neutral-50 text-[12px] text-black font-normal font-farsi-regular py-2 px-4.5 placeholder:text-neutral-400 transition-all duration-200 focus:outline-0 focus:outline-none focus:border-neutral-400 focus:border-[1px]"></textarea>
                            </div>
                            <div class="w-full">
                                <iframe class=" w-full h-[250px] rounded-xl 512max:h-[160px]" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d11879.097076998887!2d51.38925232364651!3d35.73699554213622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sfa!2s!4v1737705495356!5m2!1sfa!2s" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                    <div class="w-full flex items-center justify-end gap-4.5 pt-4.5">
        ...
        <div class="hotelEditAttrModal modal w-[100vw] h-[100vh] fixed z-[15] top-0 left-0 bg-[#0000002c] px-6 py-4">
            <div class=" modal-content w-full h-full flex items-center justify-center">
                <form action="#" class="w-full max-w-[800px] p-4.5 bg-light rounded-xl flex flex-col">
